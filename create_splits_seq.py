...
parser.add_argument('--task', type=str, choices=['crc_metStatus_TCGA'])
...
if args.task == 'crc_metStatus_TCGA':
    args.n_classes=2
    dataset = Generic_WSI_Classification_Dataset(csv_path = 'dataset_csv/crc_metStatus_TCGA.csv',
                            shuffle = False,
                            seed = args.seed,
                            print_info = True,
