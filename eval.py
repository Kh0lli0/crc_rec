...
parser.add_argument('--task', type=str, choices=['pca_ERG_TCGA', 'pca_ERG_NatHist', 'pca_pten_TCGA', 'pca_pten_NatHist', 'crc_metStatus_TCGA'])
...
elif args.task == 'crc_metStatus_TCGA':
    args.n_classes=2
    dataset = Generic_MIL_Dataset(csv_path = 'dataset_csv/crc_metStatus_TCGA.csv',
                            data_dir= args.data_root_dir,
                            shuffle = False,
                            print_info = True,
                            label_dict = {'no_rec':0, 'rec':1},
                            patient_strat=False,
                            label_col = 'label',
                            ignore=[])
